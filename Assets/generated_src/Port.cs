...
public class Port : Contactable {
  ...
  internal Port(IntPtr cPtr, bool cMemoryOwn) : base(yarpPINVOKE.Port_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public bool replyAndDrop(PortWriter writer) {
  ...
  public void setInputMode(bool expectInput) {
    yarpPINVOKE.Port_setInputMode(swigCPtr, expectInput);
  }

  public void setOutputMode(bool expectOutput) {
    yarpPINVOKE.Port_setOutputMode(swigCPtr, expectOutput);
  }

  public void setRpcMode(bool expectRpc) {
