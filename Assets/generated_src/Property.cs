...
public class Property : Searchable {
  ...
  internal Property(IntPtr cPtr, bool cMemoryOwn) : base(yarpPINVOKE.Property_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public void put(string key, Value value) {
    yarpPINVOKE.Property_put__SWIG_2(swigCPtr, key, Value.getCPtr(value));
    if (yarpPINVOKE.SWIGPendingException.Pending) throw yarpPINVOKE.SWIGPendingException.Retrieve();
  }
