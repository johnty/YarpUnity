...
public class Contact : IDisposable {
  ...
  public static ConstString convertHostToIp(string name) {
    ConstString ret = new ConstString(yarpPINVOKE.Contact_convertHostToIp(name), true);
    return ret;
  }

  public Contact(Contact alt) : this(yarpPINVOKE.new_Contact__SWIG_0(Contact.getCPtr(alt)), true) {
    if (yarpPINVOKE.SWIGPendingException.Pending) throw yarpPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public Contact() : this(yarpPINVOKE.new_Contact__SWIG_1(), true) {
  }
