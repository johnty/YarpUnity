...
public class DVector : IDisposable, System.Collections.IEnumerable
...
#endif
 {
  ...
  public DVector(System.Collections.ICollection c) : this() {
    if (c == null)
  ...
  public DVector() : this(yarpPINVOKE.new_DVector__SWIG_0(), true) {
  }
  ...
  public DVector(int capacity) : this(yarpPINVOKE.new_DVector__SWIG_2(capacity), true) {
    if (yarpPINVOKE.SWIGPendingException.Pending) throw yarpPINVOKE.SWIGPendingException.Retrieve();
  }
